...
public class PlayerMovement : MonoBehaviour
{
	...
	#endregion
	[Header("Music")]
	[SerializeField] public AudioSource gameplayMusic;
	[SerializeField] public AudioSource dialogueMusic;
	[SerializeField] private float gameplayVolumeLevel;
	[SerializeField] private float dialogueVolumeLevel;
	private void Awake()
	{
	...
	private void Start()
	{
		...
		IsFacingRight = true;
		oldSpeed = Data.runMaxSpeed;
		oldJump = Data.jumpForce;
	}
	...
	private void Update()
	{
		...
		dialogueMusic.volume = dialogueVolumeLevel;

		if (!inDialogue())
		{
			dialogueMusic.volume = 0;
			gameplayMusic.volume = gameplayVolumeLevel;
			#region TIMERS
			...
			if (Input.GetKeyUp(KeyCode.Space) || Input.GetKeyUp(KeyCode.C) || Input.GetKeyUp(KeyCode.J) || Input.GetKeyUp(KeyCode.JoystickButton0))
			{
				OnJumpUpInput();
			}
			#endregion
